...
{{--                                        <input type="hidden" name="question[{{ $question->id }}]" value="{{ $question->id }}">--}}
                                        <input type="hidden" name="question[{{ !empty($is_mock) ? $question->id : $question->question_id }}]" value="{{ !empty($is_mock) ? $question->id : $question->question_id }}"> <!-- 4-1-22-1 -->
                                        <input type="hidden" name="question_ids[]" value="{{ !empty($is_mock) ? $question->id : $question->question_id }}">  <!--free and mock end 11-1-22 -->
                                        <div class="form-card" id="fildset{{ $question->id }}">
                                            ...
                                            <h3 class="question-title" id="loop{{ $question->id }}" data-loop="{{ $loop->iteration }}" style="margin-top: 55px">{{ $loop->iteration }} - {{ $question->title }}</h3>
...
{{--                                                                <input id="asw{{ $answer->id }}" type="checkbox" name="question[{{ $question->id }}][answer]" value="{{ $answer->id }}">--}}
                                                                <input id="asw{{ $answer->id }}" type="checkbox" name="question[{{ !empty($is_mock) ? $question->id : $question->question_id }}][answer]" value="{{ $answer->id }}">  <!-- 4-1-22-1 -->
...
{{--                                                                <input id="asw{{ $answer->id }}" type="radio" name="question[{{ $question->id }}][answer]" value="{{ $answer->id }}">--}}
                                                                <input id="asw{{ $answer->id }}" type="radio" name="question[{{ !empty($is_mock) ? $question->id : $question->question_id }}][answer]" value="{{ $answer->id }}"> <!-- 4-1-22-1 -->
