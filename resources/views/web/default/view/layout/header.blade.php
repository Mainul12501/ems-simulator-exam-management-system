...
<div class="container-fluid">
    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="row middle-header">
            {{-- <div class="col-md-3 col-xs-12 tab-con"> --}}
             <div class="col-md-3 col-xs-12 tab-con test">
                    <div class="row">
                        ...
                        <a href=""><img src={{asset('/bin/admin/pmwebclass/200X55.png')}} alt="Logo"></a>
                    </div>
              </div>
            {{-- </div> --}}
            ...
            <div class="col-md-7 col-xs-12 text-center tab-con">
                <div class="row">
                <a href="/user/quizzes" class="header-upload-button pulse"><span class="headericon mdi mdi-animation"></span>PMDeepDive</a>
              <!--  <a href="/" class="header-upload-button"><span class="headericon mdi mdi-arrow-up-bold"></span>Home Page</a> -->
                        ...
                        <a href="/user/ticket" class="header-login-in-button">
                            ...
                            <div class="animated user-overlap sbox3">
                                ...
                                <ul>
                                    ...
                                    <li><a href="/user/dashboard"><span class="headericon mdi mdi-gauge"></span>
                                            <p>{{ trans('main.dashboard') }}</p></a></li>
                                   
                                    <li><a href="/user/quizzes"><span class="headericon mdi mdi-newspaper-variant-multiple-outline"></span>
                                            <p>{{ trans('main.quizzes') }}</p></li>
