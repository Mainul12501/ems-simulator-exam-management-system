...
{{--                                <a href="javascript:void(0);" class="btn btn-custom pull-left" id="buyBtn">{{ trans('main.purchase') }}</a>--}}
                                <!-- <a href="https://sandbox.sslcommerz.com/EasyCheckOut/testcde5f4efbcd6f63f43d93879e4cbf4946ec" class="btn btn-custom pull-left" id="buyBtn">{{ trans('main.purchase') }}</a> -->
