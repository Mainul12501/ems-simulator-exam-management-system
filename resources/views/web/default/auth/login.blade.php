            ...
            <div class="formBox level-login" dir="ltr">
                ...
                <div class="box loginBox">
                    ...
                    <form class="form" action="/login" method="post" id="loginForm" style="text-align: left;direction: ltr">
                        ...
                        <input class="input-rem" type="checkbox" name="remember" value="1" style="display:block;position: relative;top: 12px;width: auto;height: auto"><label style="margin-left: 15px;">{{ trans('main.remember') }}</label>
                ...
                <div class="box registerBox" style="height: 650px">
                    ...
                    <form class="form" method="post" action="/registerUser" style="text-align: left">
                        ...
                        <div class="form-group tab-con">
                            <input type="checkbox" class="input-r" name="terms" style="display: block;position: relative;top: 12px;width: auto;height: auto" valid-title="If you want to continue please accept terms and rules" required>
