...
//            mainul
            Route::get('role/list', 'AdminController@userRolesLists');
            Route::get('role/edit/{id}', 'AdminController@userRolesedit');
            Route::get('role/delete/{id}', 'AdminController@userRolesdel');
            Route::post('role/store', 'AdminController@userRolestore');
